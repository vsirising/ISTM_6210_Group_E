...
if(isset($_POST['upload'])){
    ...
    $file_destination       = "yoga/".$video_name;
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/Yoga.css">
</head>
							...
							<div class="header-text">
								<div class="row">
									<div class="col-md-12 text-center">
										<h1 style="color:white">Today's Yoga Day!</h1>
										<h1 class="typed-cursor" style="color:yellow" class="black typed"> Yoga to upload every now and zen</h1>
...
<!-- Yoga Display & Workouts -->					
				<section>
					<div class="container">
						<div class="row text-center title">
							<h2>YOGA</h2>
							<h4 class="light muted"> NAMASTE!</h4>
				...
				<section  class="section gray-bg">
                    ...
                    <h3>Existing Yoga contents</h3>
                           ...
                           <div class="alb">
                            <?php 
                             include "config.php";
                             $sql = "SELECT * FROM contents WHERE Type = 'yoga'";
                             $res = $db->query($sql);
                             $res->execute();
                               ...
                               <div class="row text-center title">
                                ...
                                <video width="100%" controls><source src ="<?php echo 'yoga/' .$name;?>"></video>
...
<!-- User Modal Display -->
			...
			<div class="modal-content modal-popup">
                ...
                <form class="popup-form" method="post" action = Iyoga.php enctype="multipart/form-data">
                    ...
                    <div class = "form-group">
                        <input type = "text" name = "type" class = "form-control" id = "type" placeholder="Enter Type" value = "yoga" readonly>
                    </div>
                    <div class = "form-group">
