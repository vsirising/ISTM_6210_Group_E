...
if(isset($_POST['upload'])){
    ...
    $file_destination       = "strength/".$video_name;
							...
							<div class="header-text">
								<div class="row">
									<div class="col-md-12 text-center">
										<h1 style="color:white">Today's Strenght Day!</h1>
										<h1 class="typed-cursor" style="color:yellow" class="black typed"> What do you call a muscle-bound bee?</h1>
...
<!-- Yoga Display & Workouts -->	
			...
			<section  class="section gray-bg">
                ...
                <div class="container">
                <div class="row text-center title">
                <h3>Existing Strength contents</h3>
                </div>    
...
<!-- User Modal Display -->
			...
			<div class="modal-content modal-popup">
                ...
                <form class="popup-form" method="post" action = Istrength.php enctype="multipart/form-data">
                    ...
                    <div class = "form-group">
                        <input type = "text" name = "type" class = "form-control" id = "type" placeholder="Enter Type" value = "strength" readonly>
                    </div>
                    <div class = "form-group">
